...
OUT="${OUT:-$ROOT/build/linux-6.6-omap2plus-steelhead-nosmp-audio-wifi-public-debian-ldc}"
IMAGE="${IMAGE:-$ROOT/artifacts/nexusq-linux66-omap2plus-nosmp-audio-wifi-public-debian-ldc.img}"
ZIMAGE_DTB="${ZIMAGE_DTB:-$ROOT/artifacts/linux66-omap2plus-steelhead-nosmp-audio-wifi-public-debian-ldc-zImage-dtb}"
